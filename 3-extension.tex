...
\Cref{rule:wpE-exists} mirrors \cref{rule:wpU-all}, but uses existential quantifiers instead of universal ones. Without much surprise, $\wpsymb_{\exists}$ works better with existentials. \Cref{rule:wpE-while} was modified to take into account the necessity of projectability for $\wpsymb_{\exists}$ statements.
