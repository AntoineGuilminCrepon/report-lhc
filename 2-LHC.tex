...
We now introduces a new modality to the logic, directly inspired from the original Hoare logic: the weakest precondition predicate. Extending it to hyperterms and hyperassertions gives the following definition:
